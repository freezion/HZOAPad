...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])){
		...
		tokenField = [[TITokenField alloc] initWithFrame:CGRectMake(0, 0, 1024, 42)];
		...
		separator = [[UIView alloc] initWithFrame:CGRectMake(0, tokenFieldBottom, 1024, 1)];
...
- (void)setFrame:(CGRect)frame {
	...
	[tokenField setFrame:((CGRect){tokenField.frame.origin, {1024, tokenField.bounds.size.height}})];
